...
# Version history
	...
	* Version 2.0.0 - 2018-09-22 - Split loguru.hpp into loguru.hpp and loguru.hpp
	* Version 2.1.0 - 2019-09-23 - Update fmtlib + add option to loguru::init to NOT set main thread name.

# Compiling
	Just include <loguru.hpp> where you want to use Loguru.
	Then, in one .cpp file #include <loguru.hpp>
...
*/
	...
	#error "You are defining LOGURU_IMPLEMENTATION. This is for older versions of Loguru. You should now instead include loguru.hpp (or build it and link with it)"
#endif
